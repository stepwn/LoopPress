...
function add_looppress_tinymce_plugin($plugin_array) {
    $plugin_array['looppress_button_script'] = plugins_url('../js/looppress-tinymce-plugin.js', __FILE__);
    return $plugin_array;
}
...
window.addEventListener('message', function(event) {
    ...
    <div id="looppress_editorModal" style="display:none;width:100%">
        <div id="looppress_modalContent" style="width:90%">
            ...
            <iframe id='looppress_visual_editor' src="<?php echo plugins_url('../html/editor.html', __FILE__); ?>" width="100%" height="90%"></iframe>
        </div>
    </div>
    <?php
}
