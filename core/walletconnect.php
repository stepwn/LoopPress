...
function walletconnect_enqueue_scripts() {
    ...
    $current_user_id = get_current_user_id();
     ...
     $proxy_key = get_user_meta($current_user_id, 'looppress_api_key', true);
    ...
    "const looppressKey = '%s'; const wc_projectId = '%s'; const plugin_dir = '%s'; const lrc_account_id = '%s'; const eth_address = '%s';",
